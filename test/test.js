...
describe('单元测试', function () {
  ...
  describe('curry', function () {
    it('error', function () {
      expect(function () {
        curry(1);
      }).to.throwException('curry: first param must is function');
      expect(function () {
        curry(function () {}, 'ggg');
      }).to.throwException('curry: second param must is number');
    });
  ...
  describe('curryRight', function () {
    it('error', function () {
      expect(function () {
        curryRight(1);
      }).to.throwException('curryRight: first param must is function');
      expect(function () {
        curryRight(function () {}, 'ggg');
      }).to.throwException('curryRight: second param must is number');
    });
  ...
  describe('debounce', function () {
    it('error', function () {
      expect(function () {
        debounce(1);
      }).to.throwException('debounce: first param must is function');
      expect(function () {
        debounce(function () {}, 'ggg');
      }).to.throwException('debounce: second param must is number');
    });
  ...
  describe('throttle', function () {
    it('error', function () {
      expect(function () {
        throttle(1);
      }).to.throwException('throttle: first param must is function');
      expect(function () {
        throttle(function () {}, 'ggg');
      }).to.throwException('throttle: second param must is number');
    });
